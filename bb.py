...
def rrpp(contact_url,id,company_name):
    ...
    cc = page.ele('xpath://*[@id="productTitle"]',timeout=2)
    if cc:
        ...
        sa = page.ele('xpath://*[@id="13772573015436"]/div/div/div[2]/div[1]/div/div[1]/div',timeout=2)
        if sa:
    ...
    bb = page.ele('xpath://*[@id="mainPrice"]/div/div/div[1]',timeout=2)


    if bb:
        价格 = page.ele('xpath://*[@id="mainPrice"]/div/div/div[1]').text
    else:
        sa = page.ele('xpath://*[@id="13772573015436"]/div/div/div[2]/div[3]/div/div/div/div[2]/div[1]/div',timeout=2)
        if sa:
    ...
    pp = page.ele('xpath://*[@id="productAttributes"]/div/div/div[3]/div/div/div/table/tbody/tr[1]/td[1]/span/span',timeout=3)
    if pp:
        尺寸 = page.ele(
    ...
    qq = page.ele('xpath://*[@id="productAttributes"]/div/div/div[3]/div/div/div/table/tbody/tr[1]/td[2]/span/span',timeout=3)
    if qq:
        货号 = page.ele(
            'xpath://*[@id="productAttributes"]/div/div/div[3]/div/div/div/table/tbody/tr[1]/td[2]/span/span').text
    else:
        oo = page.ele('xpath://*[@id="13772573013169"]/div/div[2]/div/div/div[4]/span[2]',timeout=2)
        if oo:
...
# 安德利集团有限公司	https://www.1688.com/factory/andelibpq888.html
# 安徽呵宝儿童用品有限公司	https://www.1688.com/factory/anhuihope.html
# 安徽江南泵阀集团有限公司	https://www.1688.com/factory/ahjxhong.html
# 平阳县梵特电子有限公司	https://www.1688.com/factory/b2b-1613749191.html
# 广州奇雅丝纺织品有限公司	https://www.1688.com/factory/b2b-1634579931.html


# 广州市剑火工业设备有限公司	https://www.1688.com/factory/b2b-1622743913.html
# 广州艾玛压缩机有限公司	https://www.1688.com/factory/b2b-1591222615.html


# 建德市惠兴电缆有限公司	https://www.1688.com/factory/b2b-1124395289.html
# 徐州万达回转支承有限公司	https://www.1688.com/factory/b2b-1588008053.html
# 慈溪市合丰塑料包装厂	https://www.1688.com/factory/b2b-1640246142.html
# 慈溪市嘉驰电器有限公司	https://www.1688.com/factory/artyu.html
# 慈溪市天硕工贸有限公司	https://www.1688.com/factory/775237.html
# 慈溪市安士通信设备有限公司	https://www.1688.com/factory/anshitelecom.html
# 扬州东泰电源有限公司	https://www.1688.com/factory/b2b-1116768819.html




if __name__ == "__main__":
#     factory_info_get('https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.6.415f7d75nT9fmU&memberId=0755yyt','宁波铭瑞传感器有限公司')
#     factory_info_get('https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.10.79f37f8dudv6ox&memberId=andelibpq888','安德利集团有限公司')
#     factory_info_get('https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.6.789e9f0cAy01Mz&memberId=b2b-1637335263','安徽呵宝儿童用品有限公司')
#     factory_info_get('https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.6.1b2f34f2ClxT8X&memberId=ahjxhong','安徽江南泵阀集团有限公司')
#     factory_info_get('https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.15.50134f7f2hkt48&memberId=b2b-1613749191','平阳县梵特电子有限公司')
#     factory_info_get('https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.13.33005130ET5kXO&memberId=b2b-1634579931','广州奇雅丝纺织品有限公司')
#     factory_info_get(
#         'https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.6.2e5d18ab0X5JPl&memberId=b2b-1622743913',
#         '广州市剑火工业设备有限公司')
#     factory_info_get(
#         'https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.8.15c2735dJfIeJW&memberId=b2b-1591222615',
#         '广州艾玛压缩机有限公司')
# # *************
#
#     factory_info_get(
#         'https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.6.3d113715Y1r66t&memberId=b2b-1124395289',
#         '建德市惠兴电缆有限公司')
#
#
#     factory_info_get(
#         'https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.6.3a816e85d04IFI&memberId=b2b-1588008053',
#         '徐州万达回转支承有限公司')
#
#
#
#     factory_info_get(
#         'https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.10.15d15b81FFAe6x&memberId=b2b-1640246142',
#         '慈溪市合丰塑料包装厂')
#
#
#     factory_info_get(
#         'https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.6.42305b36pMjAGP&memberId=artyu',
#         '慈溪市嘉驰电器有限公司')
#
#
#     factory_info_get(
#         'https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.6.4bb36061odYaZO&memberId=anshitelecom',
#         '慈溪市安士通信设备有限公司')
#     factory_info_get(
#         'https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.11.40a828b2KUH84E&memberId=b2b-1116768819',
#         '扬州东泰电源有限公司')
    # taobao('')
    # 定义更新的数据

    # 分批获取 company_name 并更新  https://www.alibaba.com/?spm=a2700.7699653.scGlobalHomeHeader.8.7bc23e5fPULsrC

    # for batch in fetch_company_names_in_batches(batch_size=10,start_offset=110):
    #
    #     print(f"正在处理批次：{batch}")
    #
    #     for company_name in batch:
    #
    #         print(f"正在更新公司：{company_name}")
    #
    #
    ...
    #         try:
    #
    #             new_data = taobao(company_name)
    #
    #             # update_company_info(company_name, new_data)
    #
    #         except:
    #
    #             print(f"更新失败，错误信息")

    for batch in fetch_company_names_in_batches_url(batch_size=10,start_offset=1038):
        print(f"正在处理批次：{batch}")
        for contact_url,id,company_name in batch:
            ...
            try:
                time.sleep(3)
                data = rrpp(contact_url,id,company_name)
