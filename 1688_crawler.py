...
if __name__ == "__main__":
    # factory_info_get(
    #     'https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.6.281a7de6MwmZ94&memberId=aiyingde',
    #     '绍兴市爱英德包装有限公司')
    # factory_info_get(
    #     'https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.6.7bc9290fWCkaQj&memberId=b2b-1652743206',
    #     '维峰电子（广东）股份有限公司')
    # factory_info_get(
    #     'https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.6.33136241NLqbI6&memberId=aibusheng',
    #     '金华市华发新型建材有限公司')
    factory_info_get(
        'https://sale.1688.com/factory/l6rr893d.html?spm=a262cb.19918180.ljxo5qvc.6.120e2db9St2Yel&memberId=b2b-1638252267',
        '金华源顺工艺品有限公司')
    ...
    # for batch in fetch_company_names_in_batches_url(batch_size=10,start_offset=326):
    #     print(f"正在处理批次：{batch}")
